...
const meta = {
  docs: {
    description: 'flow-when-mark enforces command handlers to call a method of the mark parameter at the end of their code paths.',
    category: 'wolkenkit',
    recommended: Boolean(recommended['wolkenkit/flow-when-mark'])
  },
  schema: []
};
